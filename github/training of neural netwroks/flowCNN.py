...
EPOCH = 10000 #30000  # train the training data n times, to save time, we just train 1 epoch
# BATCH_SIZE = 50
...
physics = 'velocity'
Y = data.iloc[:, 112:115].to_numpy()  # velocity
...
for epoch in range(EPOCH):
    ...
    optimizer.step()
    ##
    train_accuracy = (output - train_y) / train_y
    ...
    test_accuracy = (test_prediction - test_y) / test_y
