...
y = trainingSet.iloc[:, 112:115]  # velocity
test_X = testSet.iloc[:, 0:112]
test_y = testSet.iloc[:, 112:115]
...
for t in range(300):
    ...
    accuracy = (test_prediction - test_y) / test_y
    # print(accuracy)
...
plt.savefig('./results/velocity_net_train_loss.png')
np.save('./results/velocity_train_loss_his.npy', loss_his)
...
plt.savefig('./results/velocity_net_test_loss.png')
np.save('./results/velocity_test_loss_his.npy', test_loss_his)
...
plt.xlabel('Steps')
plt.ylabel('Accuracy')
plt.savefig('./results/velocity_net_accuracy.png')
np.save('./results/velocity_accuracy.npy', accuracy_his)
...
plt.xlabel('Steps')
plt.ylabel('Accuracy')
plt.savefig('./results/velocity_net_train_accuracy.png')
np.save('./results/velocity_train_accuracy.npy', train_accuracy_his)

torch.save(net, ('./results/velocity_net.pkl'))
