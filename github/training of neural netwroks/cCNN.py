...
EPOCH = 1600  # train the training data n times, to save time, we just train 1 epoch
# BATCH_SIZE = 50
...
Y = data.iloc[:, 115:117].to_numpy()  # concentration
...
class CNN(nn.Module):
    def __init__(self):
        ...
        self.out = nn.Linear(288, 2)  # fully connected layer
